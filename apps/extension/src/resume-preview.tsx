      ...
      >
        <ReactMarkdown
          components={{
            ...
            h3: ({children}) => <h3 className="text-sm font-semibold text-gray-900 mb-2 mt-3">{children}</h3>,
            p: ({children}) => <p className="text-sm text-gray-700 mb-2 leading-relaxed">{children}</p>,
            ul: ({children}) => <ul className="text-sm text-gray-700 mb-2 space-y-1 list-disc list-inside">{children}</ul>,
            ol: ({children}) => <ol className="text-sm text-gray-700 mb-2 space-y-1 list-decimal list-inside">{children}</ol>,
