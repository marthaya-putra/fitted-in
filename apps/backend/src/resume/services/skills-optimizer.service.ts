...
MAXIMUM OF 3 SKILL GROUPS: Select and organize only the top 3 most relevant skill categories that align with the job description. Prioritize categories that contain the most relevant and frequently mentioned skills in the job requirements.
...
LIMIT TO MAXIMUM 3 SKILL GROUPS - select only the most relevant categories based on job description requirements.
