...
- Latest/most recent experiences: Maximum 3 achievements
- Older experiences: Maximum 2 achievements
...
CRITICAL DATE PRESERVATION RULE: Preserve exact dates from the source. Do NOT change end dates to "Present" unless the source explicitly says "Present" or "Current". Keep all dates exactly as provided in the input.`;
